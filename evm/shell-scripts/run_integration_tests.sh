...
anvil \
    -m "myth like bonus scare over problem client lizard pioneer submit female collect" \
    --port 8547 \
    --fork-url $KLAYTN_FORK_RPC > anvil_avax.log &
...
RELEASE_WORMHOLE_ADDRESS=$KLAYTN_WORMHOLE_ADDRESS \
RELEASE_CIRCLE_BRIDGE_ADDRESS=$KLAYTN_CIRCLE_BRIDGE_ADDRESS \
RELEASE_WORMHOLE_FINALITY=$KLAYTN_WORMHOLE_FINALITY \
forge script $EVM_ROOT/forge-scripts/deploy_contracts.sol \
